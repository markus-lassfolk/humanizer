...
Detailed technical documentation for all **36** AI writing pattern slots in humanizer (pattern **36** contributes via optional LM uniformity, not standalone regex hits).
...
| 2 | Weak signal | Rule of three (10), Synonym cycling (11), False ranges (12), Em dash overuse (13), Boldface overuse (14), Emoji overuse (17), **Passive voice density (30)**, **Weasel words (32)** |
| 1 | Minor tell | Title Case headings (16), Curly quotes (18), **Adverb density -ly (31)**, **Clichés (33)**, **Redundancy (34)**, **Inclusive language / strict (35)** |
| 0 | Uniformity-only | **LM n-gram boost (36)** — no pattern rows; use `--with-lm` (English) |

English-only detectors **30–35** are documented in [`locales/en-en/references/patterns-en.md`](../locales/en-en/references/patterns-en.md).
