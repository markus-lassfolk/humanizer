...
const TIER_2 = [
  ...
  'subsequently', 'accordingly', 'nonetheless', 'henceforth',
  'indeed', 'specifically', 'essentially', 'ultimately',
  'arguably', 'fundamentally', 'inherently', 'profoundly',
