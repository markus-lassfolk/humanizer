 ...
 *
 * Reads locales/sv-se/tests/fixtures/sv-corpus/{human,human-gold,ai}/
...
/** human-news-01.txt / ai-government-02.txt / human-government-gold-01.txt → genre segment */
...
function main() {
  ...
  if (humanDocs.length === 0 || aiDocs.length === 0) {
    console.error('Missing sv-corpus. Run: node locales/sv-se/scripts/seed-sv-corpus.mjs');
    process.exit(1);
  }
